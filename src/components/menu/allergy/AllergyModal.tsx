    ...
    <div className={classes.backdrop} onClick={onClose}>
      <div className={classes.container} onClick={(e) => e.stopPropagation()}>
        ...
        <div className={classes.description_container}>
          ...
          <p>
            Our food is freshly prepared in store where equipment and utensils
            are shared, so we cannot guarantee that any product is free from
            allergens, even after ingredients have been removed on request, due
